...
var rootCmd = &cobra.Command{
	Use:   "blink",
	Short: "A CLI based add on manager for World Of Warcraft",
	Long: `Blink is a CLI based add on manager for World of Warcraft that downloads, installs, and manages WoW add ons
via github releases.`,
